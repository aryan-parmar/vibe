...
let data= [
  {name: "landslide", cover: "/cover6.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "starboy", cover: "/cover2.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "basti ka hasti", cover: "/cover3.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "this is what falling in love feels", cover: "/cover4.jpg", src:"/song.mp3", artist: "basti ka hasti"},
]
let data2= [
  {name: "landslide", cover: "/cover6.jpg", src:"/song2.mp3", artist: "basti ka hasti"},
  {name: "starboy", cover: "/cover2.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "basti ka hasti", cover: "/cover3.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "this is what falling in love feels", cover: "/cover4.jpg", src:"/song.mp3", artist: "basti ka hasti"},
  {name: "untill i found you", cover: "/cover5.jpeg", src:"/song2.mp3", artist: "basti ka hasti"},
]
      ...
      <div className="flex-1 h-[calc(100vh-20px)] overflow-y-auto w-full overflow-x-hidden scroll-smooth">
        ...
        <div className="h-12 w-full flex justify-start items-center gap-2 sticky top-0 p-4 pl-4 z-40 bg-[#10151ef1]">
          ...
          <div className="h-9 flex justify-center items-center rounded-lg bg-[#4f4f4f70]">
            <label htmlFor="search" className="h-full flex gap-1 justify-center items-center pl-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-auto h-[50%] fill-white">
