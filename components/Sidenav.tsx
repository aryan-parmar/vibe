...
const Sidenav = () => {
  return (
    <div className="hidden md:flex md:flex-[0.15] lg:flex-[0.2] h-full z-10 rounded-r-2xl backdrop-blur-md flex-col justify-start items-center sidenav inset-0 gap-4">
